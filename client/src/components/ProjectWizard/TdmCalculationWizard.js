      ...
      >
        ...
        <div className="scroll">
          ...
          <p className="smaller">
            ...
            Transportation Demand Management (TDM) Calculator (TDM Calculator)
            to provide the public with an understanding of the TDM Ordinance.
            ...
            the reliance on drive-alone trips in the City of Los Angeles. The
            term “City” as used below shall refer to the City of Los Angeles.
            The terms “City” and “Hack for LA” as used below shall include their
          ...
          <p className="smaller">
            ...
            that land use development would need to comply with if the City were
            to adopt the TDM Ordinance. LADOT is pleased to be able to provide
            this information to the public. LADOT believes that the public is
            most effectively served when they are provided access to the
            technical tools that inform the public policy-making process that
            governs private and public land-use investments. However, in using
            the TDM Calculator, You agree to be bound by this TDM Calculator
          ...
          <p className="smaller">
            ...
            Your failure to follow the terms of this Agreement shall
          ...
          <p className="smaller">
            ...
            contained within the TDM Calculator and the reliance upon
            information from outside sources, the City does not guarantee the
            accuracy or reliability of the information transmitted from this web
            site. The TDM Calculator, OUTPUTS AND ASSOCIATED DATA ARE PROVIDED
            “as is” WITHOUT WARRANTY OF ANY KIND, whether expressed, implied,
            statutory or otherwise including but not limited to, warranties of
            title or the implied warranties of merchantability and fitness for a
            particular purpose. Neither the City nor Hack for LA are responsible
            for any special, indirect, incidental, or consequential damages that
            may arise from the use of, or the inability to use, the data and/or
            the materials contained on the data whether the materials contained
            on the data are provided by the City or a third party.
          </p>
          ...
          <p className="smaller">
            ...
            errors or omissions arising out of your use of the TDM Calculator or
            with respect to the material contained within the TDM Calculator.
          </p>
          ...
          <p className="smaller">
            ...
            provisions and shall be effective as of the date that You are making
            use of the TDM Calculator. Any action brought to enforce the
            Agreement and/or in connection with this website shall be brought in
            either the state or federal courts in the County of Los Angeles

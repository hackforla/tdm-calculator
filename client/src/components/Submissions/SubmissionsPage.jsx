...
import SubmissionTableRow from "../ManageSubmissions/SubmissionTableRow";
...
const SubmissionsPage = ({ contentContainerRef }) => {
  ...
  const formatDatesFromCookieStringify = sessionFilterCriteria => {
  ...
  const [filterCriteria, setFilterCriteria] = useState(
    formatDatesFromCookieStringify(sessionFilterCriteria)
  );

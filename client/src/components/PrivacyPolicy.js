        ...
        <div className="tdm-wizard-content-container">
          ...
          <div className={(classes.aboutText, classes.scroll)}>
            ...
            <ul>
              ...
              <li className={classes.parentBullets}>
                We use this non personally identifiable information to
                understand how the
                <span> </span>
                <a
                  className={classes.link}
                ...
                website is used, to improve the website, and to monitor usage
            ...
            <ul>
              <li className={classes.parentBullets}>
                All saved projects will be saved with all the inputs filled out
                as well as with name of the user creating it
              </li>
              <li className={classes.parentBullets}>
                Approve “admin accounts” will be able to view but not edit user
                projects, and will be able to see the name of the user who
                created the account. No other account information will be
                viewable
              </li>
            </ul>
            <p className={classes.topMargin}>
            ...
            <ul>
              ...
              <li className={classes.parentBullets}>
                ...
                other user data such as logins, passwords, or saved projects
                will be included.
              </li>
              <li className={classes.parentBullets}>
            ...
            <ul>
              ...
              <li className={classes.parentBullets}>
                ...
                Google Analytics, and we do not combine the information
                collected through Google Analytics with any personally
            ...
            <p className={classes.topMargin}>
              Google Analytics, Google has developed the Google Analytics
              opt-out browser add-on for the Google Analytics JavaScript (ga.js,
            ...
            <ul>
              {" "}
              <li className={classes.parentBullets}>
                Cookies are small text files that websites place on the
                computers and mobile devices of people who visit those websites.
                Pixel tags (also called web beacons) are small blocks of code
                placed on websites and emails.
              </li>
              <li className={classes.parentBullets}>
                We use cookies and other technologies like pixel tags to
                remember your preferences, enhance your online experience, and
                to gather data on how you use our Sites to improve the way we
                promote our content, programs, and events.
              </li>
              <li className={classes.parentBullets}>
            ...
            <ul>
              <li className={classes.parentBullets}>
                ...
                information from children under 13 years of age, and no part of
                our Site is directed to children.
              </li>
              <li className={(classes.parentBullets, classes.bottomMargin)}>
            ...
            <ul>
              ...
              <li className={(classes.parentBullets, classes.bottomMargin)}>
                ...
                security of the information we maintain. However, as our
                Services are hosted electronically, we make no guarantees as to
            ...
            <ul>
              <li className={classes.parentBullets}>
                ...
                deleted or removed as they are stored as part of the public
                record with the City of Los Angeles.
              </li>
              <li className={(classes.parentBullets, classes.bottomMargin)}>
                ...
                Project information) at any time. You may request that
                incomplete data be completed or that incorrect data be
            ...
            <p>
              ...
              continued use of this site after any changes in this Privacy
            ...
            <p>
              ...
              related to our Review Tool websites, please contact us by email at

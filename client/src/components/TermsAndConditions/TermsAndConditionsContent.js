    ...
    <>
      ...
      <div className={classes.termsAndConditionsContent}>
        ...
        <p>
          ...
          owned, leased, or otherwise controlled by You in Your own facilities,
          as set out below and provided that You know and follow the terms of
          this Agreement. Your failure to follow the terms of this Agreement
          shall automatically terminate this license and Your right to use the
          TDM Calculator.{" "}
        </p>
        <p>
          ...
          the TDM Calculator’s parameters, including potential TDM strategies,
          and program point targets that could apply to land use development.
          However, since the TDM Ordinance is a draft regulation and not current
          law, it could further change, or be adopted in whole, or in part,
          denied, or abandoned, the information herein should not be interpreted
          to be binding on land use development regulation outcomes that inform
        ...
        <p>
          <span className={classes.bold}>Limitation of Liability.</span> It is
          ...
          incompleteness, errors, or omissions arising out of your use of the
          TDM Calculator or with respect to the material contained in the TDM
          ...
          feasible as determined solely by the City. In no event shall the City
          or Hack for LA be responsible to You or anyone else for, or have
          ...
          profits or changes to businesses costs) or lost data or downtime,
          however caused, and on any theory of liability from the use of, or the

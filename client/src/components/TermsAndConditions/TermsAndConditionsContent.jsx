...
const TermsAndConditionsContent = () => {
  ...
  return (
    <div style={{ maxWidth: "1080px", padding: "0 4rem" }}>
      ...
      <p className={classes.para}>
        ...
        with the Department of City Planning and Hack for LA (a project of Civic
        Tech Structure), has developed the City of Los Angeles Transportation
      ...
      <div className={classes.section}>Limited License to Use</div>
      <p className={classes.para}>
        This Agreement gives You a limited, non-transferable, non-assignable,
        and non-exclusive license to use the TDM Calculator on a computer system
      ...
      <div className={classes.section}>Warranty Disclaimer</div>
      <p className={classes.para}>
        LADOT worked with the Department of City Planning and Hack for LA to
        ...
        development. However, since the TDM Ordinance is a draft regulation and
        not current law, it could further change, or be adopted in whole, or in
        part, denied, or abandoned, the information herein should not be
        interpreted to be binding on land use development regulation outcomes
        that inform investment decisions. Due to the dynamic nature of the
        information contained within the TDM Calculator and the reliance upon
        ...
        site. The TDM Calculator, OUTPUTS AND ASSOCIATED DATA ARE PROVIDED “as
        is” WITHOUT WARRANTY OF ANY KIND, whether expressed, implied, statutory
        or otherwise including but not limited to, warranties of title or the
        ...
        from the use of, or the inability to use, the data and/or the materials
        contained on the data whether the materials contained on the data are
        provided by the City or a third party.
      </p>
      <p className={classes.para}>
      ...
      <div className={classes.section}>Limitation of Liability</div>
      <p className={classes.para}>
        It is understood that the TDM Calculator is provided without charge.
        Neither the City nor Hack for LA can be responsible or liable for any
